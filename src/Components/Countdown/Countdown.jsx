...
const CountdownTimer = () => {
  return (
    <div className="flex items-center justify-center h-full w-screen text-blue-600 capitalize flex-col gap-5">
      <h1 className="text-6xl font-extrabold">🎉Time Left🎉</h1>
      <Countdown
