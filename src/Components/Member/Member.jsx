        ...
        <div className="h-full w-full flex justify-center items-center gap-3">
          <div className="border-2 h-[80vh] w-[80vw] p-10 flex justify-center items-center flex-col rounded-xl gap-5 bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-20 border-gray-100">
            ...
            {leader.map(({ nama, link }, index) => (
              ...
              >
                <motion.div
                  className="h-32 w-32 lg:h-64 lg:w-64 flex justify-center items-center rounded-tr-xl rounded-bl-xl transition duration-500 ease-in-out text-center bg-blue-300 hover:bg-blue-700 hover:text-white font-bold p-5"
                  whileHover={{
                    scale: 1.1,
            ...
            <div className="flex flex-wrap lg:flex-nowrap lg:flex-row justify-center items-center gap-3">
              {members.map(({ nama, link }, index) => (
                ...
                >
                  <motion.div
                    className="h-24 w-24 lg:h-44 lg:w-44 flex justify-center items-center rounded-tr-xl rounded-bl-xl transition duration-500 ease-in-out text-center bg-blue-300 hover:bg-blue-700 hover:text-white font-bold p-5"
